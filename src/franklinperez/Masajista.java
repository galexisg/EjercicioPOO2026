...
public class Masajista extends SeleccionFutbol {
    ...
    public void darMasaje() {
        System.out.println(nombre + " está dando masajes de recuperación a los jugadores.");
    }

    // Aplicando Polimorfismo por Herencia
    @Override
    public void realizarActividadPrincipal() {
        System.out.println("[POLIMORFISMO] El Masajista " + nombre + " está preparando la sala de masajes terapéuticos.");
    }
